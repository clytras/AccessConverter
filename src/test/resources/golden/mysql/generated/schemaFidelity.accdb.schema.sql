...
CREATE TABLE `CustomerLoyaltyProgramMembershipTiers` (
  ...
  PRIMARY KEY (`TierID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci AUTO_INCREMENT=2;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci AUTO_INCREMENT=3;
CREATE TABLE `Files` (
  ...
  `Img` LONGBLOB,
  PRIMARY KEY (`FileID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_ci AUTO_INCREMENT=4;
