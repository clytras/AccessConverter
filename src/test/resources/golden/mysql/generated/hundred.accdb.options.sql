...
SET @ac_notes = @@SESSION.sql_notes, SESSION sql_notes = 0;
CREATE DATABASE IF NOT EXISTS `shop` CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_ci;
USE `shop`;
DROP TABLE IF EXISTS `After`;
DROP TABLE IF EXISTS `Hundred`;
SET SESSION sql_notes = @ac_notes;
