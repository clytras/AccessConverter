...
CREATE TABLE `Table1_attach-data` (
  ...
  `file_flags` INT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_as_ci COMMENT='The attachments of Table1.attach-data';
CREATE TABLE `Table1_multi-value-data` (
  `id` INT NOT NULL,
  `multi-value-data_ref` INT NOT NULL,
  `value` VARCHAR(255),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_as_ci COMMENT='The values of Table1.multi-value-data';
